...
class active extends StatefulWidget {
  ...
  active({this.name,this.confirmed,this.recovered,this.death,this.newconfirmed,this.newdeath,this.slug,this.newrecovered,this.date});
  List name;
  List confirmed;
  List recovered;
  List death;
...
class _activeState extends State<active> {
  ...
  void method(n,c,r,d,nc,nd,nr,slug){
    //  print(nc);
    var abc = List.generate(n.length, (i) => List(9), growable: false);
          ...
          child: Column(
            children: <Widget>[
              Card( margin:EdgeInsets.all(3) ,
                  child: Container(padding:EdgeInsets.all(5),child: Text('Top 10 countries with most active cases',style: TextStyle(color: Colors.blue,fontStyle: FontStyle.italic,letterSpacing: 1.5,fontSize: 14),),))
            ],
          ),
